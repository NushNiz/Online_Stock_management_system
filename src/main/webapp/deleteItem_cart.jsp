...
<body>
<div style="background-image: linear-gradient(#360033, #0b8793); height:900px;">
<!--Header-->
	 ...
	 <form action="deleteCart" method="post">
	  <label class="label">Item Name</label>
	    ...
	    <div class="user-box">
	     ...
	     <button type="submit" name="add" value="add" class="btn btn-primary btn-block btn-large" onclick="alert('Deleted from the Cart')">Delete from Cart</button>
