...
<!-- Validaitng Username cannot be null and password cannot be lessthan 6 characters JAVA SCRIPT validation -->
<script>  
...
<div class="login">
    ...
    <form name = "myform" action ="login" method="post" onsubmit="return validateform()">
        ...
        <div class = "lg"><button type="submit" class="btn btn-primary btn-block btn-large">LOGIN</button></div><br>
