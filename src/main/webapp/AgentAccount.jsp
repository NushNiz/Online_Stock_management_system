...
<!-- Agent name and product details and add product button -->
<center id="hello">

	<c:forEach var="Agent" items="${AgentDetails}">
	
		<h2  style="color:white;">Hello ${Agent.name}</h2>
...
<!--  	ID         : <input type="text" name="id"> <br>  -->
    ...
    <input type="submit"  name="submit" value="View Product Details" class="btn btn-primary">
...
<!--  	ID         : <input type="text" name="id"> <br>  -->
    ...
    <input type="submit"  name="submit" value="View Stock Details" class="btn btn-primary">
