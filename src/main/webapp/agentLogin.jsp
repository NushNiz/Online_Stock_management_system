...
<head>
<link rel="shortcut icon" href="C:/Users/nizme/Documents/Eclips Enterprices SLIIT/Stock_Management/src/main/webapp/images/icon.ico" type="image/x-icon" />
    <!-- Required meta tags -->
...
.reg{
	...
	color: grey; font-weight:bold; letter-spacing:1px; text-align:center;	
...
function myFunction() {
 ...
 <div class="site-mobile-menu">
	...
	<form action ="log" method="post" name = "myform" onsubmit="return validateform()">
       ...
       <div class="lg"><button type="submit" class="btn btn-primary btn-block btn-large">LOGIN</button></div>
       
		<div class="no">Not Yet Registered.?</div>
        <a class = "sign" href="StaffRegistation.jsp"><button class="btn btn-primary btn-block btn-large">SIGN UP</button></a>
	 </form>    
	</div>
