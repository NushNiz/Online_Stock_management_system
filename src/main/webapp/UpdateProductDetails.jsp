...
<!-- inserting the details to the form -->
<center><b><h1 style="color:white;">Update product details</h1></b></center>
...
<div class="form">
	...
	<input type="text" name="price" class="form-control" value="<%= price %>" required> <br>
