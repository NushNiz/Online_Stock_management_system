...
<script>
function confirm() {
	  alert("Do you want to insert the details!");  
	}
</script>
...
<center><b><h1 style="color:white;">Add products</h1></b></center>  <!-- topic -->
...
<div class="form">
	...
	<input type="text" name="id" class="form-control" pattern="[A][0-9]{3}" required> <br>
	...
	<input type="submit"  name="submit" value="Add Product Details" class="btn btn-primary" onclick="confirm()">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 pr-md-5">
            <a href="#" class="footer-site-logo d-block mb-4"><img src="images/logo.png" style="width:300px; height:300px"></a>
