...
<body>
<div style="background-image: linear-gradient(#360033, #0b8793); height:6000px;">
<!--Header-->
        ...
        <div class="row align-items-center">
	 	 ...
	 	 <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="ContactUs.jap"><span>Contact Us</span></a></li>  
                <li>
		  ...
		  <div class="allProducts">
			...
			<div class="product">
		    	...
		    	<div class="productDetails">
					...
					<a href="${addToCart}">
					<span><button name="add"><i class="fas fa-cart-plus" style="font-size:17px"></i></button></span>
					</a> 
