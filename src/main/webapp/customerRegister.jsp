        ...
        <div class="row align-items-center">
	 	 ...
	 	 <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="viewProducts.jsp"><span>Home</span></a></li>
...
<br><br>
	...
	<div class="addQty">
	<form action="add_Cus" method="post">
  <h1>Sign up</h1>
  <div class="inset">
  <p>
  ...
  <p class="p-container">
    <input type="submit" name="go" id="go" value="Sign Up" onclick="alert('Successfully Registered')">
  </p>
</form>
