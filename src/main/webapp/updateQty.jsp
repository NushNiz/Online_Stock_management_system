...
<body>
<div style="background-image: linear-gradient(#360033, #0b8793); height:800px;">
<!--Header-->
	...
	<div class="login-box">
	 ...
	 <form action="updateQuantity" method="post">
	  <label class="label">Item Name</label>
	    ...
	    <div class="user-box">
		  <input type="number" min="1" name="quantity" value="<%=quantity %>" required/>
	    </div>
	     <button type="submit" name="add" value="add" class="btn btn-primary btn-block btn-large" onclick="alert('Updated the Quantity')">Update</button>
