...
<script>
function confirm() {
	  alert("Do you want to delete the details!");
	}
</script>
...
<!--Header-->
	...
	<!-- insert product details to the form -->
	<center><b><h1 style="color:white;">Delete product details</h1></b></center>
...
<form action="Delete" method="Post">
	...
	<input type="text" name="name" class="form-control" value="<%= name %>" readonly> <br>
	
	<label class="form-label">Price</label>      
	<input type="text" name="price" class="form-control" value="<%= price %>" readonly> <br>
	
	<label class="form-label">Company</label>    
	 <input type="text" name="company" class="form-control" value="<%= company %>" readonly> <br>
	
	<label class="form-label">Description</label>
	 <input type="text" name="description" class="form-control" value="<%= description %>" readonly> <br>  

    <input type="submit"  name="submit" value="Delete Product Details" class="btn btn-primary" onclick="confirm()">
