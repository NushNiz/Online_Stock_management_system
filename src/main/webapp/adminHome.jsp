        ...
        <!-- Navigation bar -->
	 	 <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active"><a href="#"><span>Administrative View</span></a></li>
               <!-- <li class="has-children">
                ...
                <li class="has-children" style="color:black">
                ...
                <ul class="dropdown arrow-top">
                    ...
                    <a href="#">Administrative Management</a>
                      <ul class="dropdown arrow-top">
                      	<li><a href="AddEmployee.jsp">Employee Management</a></li>
                      		<li><a href="SalesInsert.jsp">Shipments</a></li>
                      	<li><a href="user-list.jsp">View Stocks</a></li>
                      
                      	
                      	</ul></li>
                <li><a href="user-list.jsp">Stock Management</a></li>
                <li><a href="ProductAccount.jsp">Products added by the Agent</a></li>
