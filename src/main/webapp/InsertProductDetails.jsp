...
<center><b><h1 style="color:white;">Insert product details</h1></b></center>
...
<div class="form">
	...
	<input type="text" name="id" class="form-control" pattern="[P][0-9]{3}" required> <br>
	...
	<input type="submit"  name="submit" value="Input Product Details" class="btn btn-primary" onclick="confirm()">
